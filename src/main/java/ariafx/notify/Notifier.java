...
public class Notifier {
    ...
    static {
        ...
        if (PlatformUtil.isWindows()) {
            ...
            Copy(source, destination);
            Extract(destination);
            notify_mac = destination.getParent() + "/AriafxNotify.app/Contents/MacOS/applet";
        }
    }
...
//		"/AriafxNotify.app/Contents/MacOS/applet";
        ...
        try {
            ...
            R.info("error in open " + e.getMessage());
        }
