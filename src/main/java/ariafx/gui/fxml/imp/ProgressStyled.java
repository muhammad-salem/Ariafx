...
public class ProgressStyled extends ProgressBar {
	...
	public ProgressStyled(double progress) {
		...
		// getStyleClass().add(StyleProgress.Light_blue.toString());
	}
	...
	public enum StyleProgress {
		DEFAULT, PRIMARY, STRIPED, DANGER, SUCCESS, INFO, WARNING, Red, Pink, Purple, Deep_purple, Indigo, Blue, Light_blue, Cyan, Teal, Green, Light_Green, Lime, Yellow, Amber, Orange, Deep_Orange, Brown, Grey, Blue_Grey;
		@Override
