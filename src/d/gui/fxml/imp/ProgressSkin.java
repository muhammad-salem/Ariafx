...
public class ProgressSkin extends BehaviorSkinBase<ProgressIndicator, BehaviorBase<ProgressIndicator>> {
    ...
    public ProgressSkin(ProgressIndicator control) {
    ...
    private class DeterminateIndicator extends Region {
        ...
        private Circle opacityCircle;

        public DeterminateIndicator(ProgressIndicator control, ProgressSkin s, Paint fillOverride) {
