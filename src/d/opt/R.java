...
public class R {
	...
	public static String[] getPaths(){
		return new String[]{DefaultPath, OptDownloadsDir,
				OptQueuesDir, OptCategoresDir,
				downloadsPath, queuesPath, categoresPath};
	}

	public static String UserHome = System.getProperty("user.home");
	public static String DefaultPath = UserHome+ File.separator + "Downloads" 
						+ File.separator + "fxGet";
	static{
		if(PlatformUtil.isWin7OrLater()){
			CachePath  = UserHome +  File.separator + "AppData" 
					+ File.separator + "Roaming" + File.separator + "fxGet" + File.separator + "cache";
			ConfigPath = UserHome + File.separator + "AppData" 
					+ File.separator + "Roaming" + File.separator + "fxGet" + File.separator + "config";
		}else if(PlatformUtil.isWindows()){
			CachePath  = UserHome +  File.separator + "Application Data" 
					+ File.separator + "fxGet" + File.separator + "cache";
			ConfigPath = UserHome + File.separator + "Application Data" 
					+ File.separator + "fxGet" + File.separator + "config";
		}
	}
	
	public static String CachePath = UserHome+ File.separator 
						+ ".cache" + File.separator + "fxGet";
	
	public static String ConfigPath = UserHome+ File.separator 
						+ ".config" + File.separator + "fxGet";
	

	public static String SettingPath = ConfigPath + File.separator
												 + "setting.json";

	public static String downloadsPath 	= ConfigPath + File.separator
												   + "downloads.json";
	public static String queuesPath		= ConfigPath + File.separator
												+ "queues.json";
	public static String categoresPath 	= ConfigPath + File.separator
												+ "categores.json";

	public static String OptDownloadsDir = ConfigPath + File.separator
												+ "downloads";
	public static String OptQueuesDir 	 = ConfigPath + File.separator
												+ "queues";
	public static String OptCategoresDir = ConfigPath + File.separator
												+ "categores";
